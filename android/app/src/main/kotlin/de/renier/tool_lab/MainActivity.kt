...
class RicochetActivity : MainActivity()
class Twenty48Activity : MainActivity()
class ChaindropActivity : MainActivity()
class LumaWellActivity : MainActivity()
class DriftBloomActivity : MainActivity()
