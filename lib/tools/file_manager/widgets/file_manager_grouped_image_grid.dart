...
class FileManagerGroupedImageGrid extends StatefulWidget {
  final Map<String, List<FileManagerEntry>> groups;
  ...
  const FileManagerGroupedImageGrid({
    super.key,
  ...
  @override
  State<FileManagerGroupedImageGrid> createState() =>
      _FileManagerGroupedImageGridState();
}

class _FileManagerGroupedImageGridState
    extends State<FileManagerGroupedImageGrid> {
