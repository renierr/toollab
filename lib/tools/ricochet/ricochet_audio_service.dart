...
class RicochetAudioService {
  ...
  static final RicochetAudioService instance = RicochetAudioService._();
  ...
  Future<void> _init() async {
    try {
      ...
      errorLog('[Ricochet] Audio unavailable, running silent: $e');
      _available = false;
    }
  }
  ...
  Future<void> register(String key, Uint8List wav) async {
    ...
    try {
      ...
      errorLog('[Ricochet] Failed to register clip "$key": $e');
    }
  }
  ...
  void play(
    ...
    try {
      ...
      debugLog('[Ricochet] play("$key") failed: $e');
    }
  }
