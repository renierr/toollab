...
import 'treadmill_health_connect_actions.dart';
...
class TreadmillSettingsSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Material rather than a decorated box: the list tiles below paint their
    // background and ink on the nearest Material ancestor, and a plain
    // background colour in between would swallow both.
    return Material(
          ...
          child: Column(
            ...
            children: [
              ...
              if (Platform.isAndroid) ...[
                ...
                const TreadmillHealthConnectActions(),
              ],
            ],
          ),
        ),
